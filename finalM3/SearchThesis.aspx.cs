    ...
    public partial class SearchThesis : System.Web.UI.Page
    {
        ...
        protected void Search(object sender, EventArgs e)
        {
            ...
            SqlConnection conn = new SqlConnection(connStr);
                ...
                SqlCommand search = new SqlCommand("searchThesis", conn);
                search.CommandType = CommandType.StoredProcedure;
                search.Parameters.Add(new SqlParameter("@keyWord ", SqlDbType.VarChar)).Value = Keyword.Text;
                ...
                conn.Open();
                SqlDataReader rdr = search.ExecuteReader(CommandBehavior.CloseConnection);
                while (rdr.Read())
                {
