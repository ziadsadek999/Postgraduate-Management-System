<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AddDefenseGrade.aspx.cs" Inherits="finalM3.AddDefenseGrade" %>
...
<body>
    <form id="form1" runat="server" class ="frmalg">
        ...
        <div class ="container">
            ...
            <asp:Label runat="server" ID ="serialWarning" Text =" "></asp:Label>
            <br />
            ...
            <br />
            <asp:Label runat ="server"><b>Grade</b></asp:Label>
            <asp:TextBox ID="Grade" runat="server" ></asp:TextBox>
            <asp:Label runat ="server" ID ="GradeWarning" Text =" " CssClass ="warning"></asp:Label>
            <br />
            <asp:Button ID="Button1" runat="server" CssClass ="lgnbtn" OnClick ="Add_Grade" Text="Add Grade" />
