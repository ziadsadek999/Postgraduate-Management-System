<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="IssueInstallment.aspx.cs" Inherits="finalM3.IssueInstallment" %>
...
<body>
    <form id="form1" runat="server" class="frmalg">
        ...
        <div class="container">
            <center>
                <h3>Issue Intallment</h3>
                <asp:Label ID="suc" runat="server" Text=" "></asp:Label>
            </center>
            <label><b>Payment ID</b></label>
            <asp:TextBox runat="server" ID="paymentID" placeholder="Enter Thesis serial number"></asp:TextBox>
            <asp:Label ID="paymentWarning" runat="server" Text=" " class="warning"></asp:Label>
            <br />
            <label><b>Progress report date</b></label>
            <div>
            ...
            <br />
            <asp:Button runat="server" ID="btn_Login" CssClass="lgnbtn" Text="Issue" OnClick="Issue" />
