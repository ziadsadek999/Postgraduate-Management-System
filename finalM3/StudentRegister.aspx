<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="StudentRegister.aspx.cs" Inherits="finalM3.StudentRegister" %>
<!DOCTYPE html>
...
<body>
    <form id="form1" runat="server" class="frmalg">
        ...
        <div class="container">
            ...
            <br />
            <label ><b>Are you GUCian?</b></label>
            <br />
            <asp:RadioButton ID="RadioButton1" runat="server" Text ="Yes" GroupName="studentType"/>
        <br />
        <asp:RadioButton ID="RadioButton2" runat="server" Text ="No" GroupName="studentType"/>
        <br />
